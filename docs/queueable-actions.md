---
title: "Queueable Actions — Fixcity Module"
type: concept
created: 2026-07-12
updated: 2026-07-12
confidence: high
tags: [queueable-action, spatie, architecture, laraxot, fixcity]
related:
  - Modules/Xot/docs/queueable-actions.md
---

# Queueable Actions — Fixcity Module Doctrine
...
```bash
cd laravel
php -d memory_limit=2048M vendor/bin/phpstan analyse Modules/Fixcity --no-progress
vendor/bin/pint Modules/Fixcity/app/Actions
```
