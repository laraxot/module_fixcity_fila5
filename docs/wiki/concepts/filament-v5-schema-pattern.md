...
created: 2026-05-05
updated: 2026-05-05
tags: [filament, schema, xot, architecture, resource-form, resource-infolist]
related:
  - concepts/xotbase-resource-form-pattern.md
  - concepts/filament-v5-architecture.md
  - entities/xotbaseresource.md
---

# Filament v5 Schema Pattern - XotBase Abstraction

## Overview

Our Laraxot architecture uses `XotBaseResourceForm` and `XotBaseResourceInfolist` as abstraction layers over Filament v5's native Schema pattern. This provides DRY, modular architecture for multi-module monoliths.
...
Filament v5 Core
    ↓
XotBaseResourceForm / XotBaseResourceInfolist (Shared Protocol)
    ↓
TicketForm / TicketInfolist (Module-Specific Content)
```

## Comparison: Filament Demo vs Our Pattern

### Filament Demo (Pure v5 Style)
...
class XotBaseResourceForm
{
    ...
    {
        // Convention: get{Name}Schema() → getStepByName('privacy') calls getPrivacySchema()
